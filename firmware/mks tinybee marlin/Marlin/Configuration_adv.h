...
#define HOMING_BUMP_MM      { 5, 5, 2, 5 }    // (mm) Backoff from endstops after first bump (X Y Z I when LINEAR_AXES 4)
#define HOMING_BUMP_DIVISOR { 2, 2, 4, 2 }    // Re-Bump Speed Divisor (X Y Z I when LINEAR_AXES 4)
...
#define AXIS_RELATIVE_MODES { false, false, false, false, false }  // X Y Z I E when LINEAR_AXES 4
